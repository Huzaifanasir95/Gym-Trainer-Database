...
{
    public partial class Main_Trainer : Form
    {
        private string username;
        private int userID;
        public Main_Trainer(string username, int userID)
        {
            InitializeComponent();
            ...
            this.panel2.BackColor = Color.FromArgb(150, Color.MediumOrchid);
        }
        ViewDiet accessdiet;
        CreateDiet creatediet;
        ViewWorkouts accessworkout;
        CreateWorkout createworkout;
        Booking booking;
        Trainer_Dash dashboard;
        //Form_Meal meal;
        ...
        private void Create_Workout_Click_1(object sender, EventArgs e)
        {
            revert_Color();
            Main_Member.Hide();
            Create_Workout.BackColor = Color.MediumOrchid;
            if (createworkout == null)
            {
                createworkout = new CreateWorkout();
        ...
        private void Access_Workout_Click_1(object sender, EventArgs e)
        {
            revert_Color();
            Main_Member.Hide();
            Access_Workout.BackColor = Color.MediumOrchid;
            if (accessworkout == null)
            {
                accessworkout = new ViewWorkouts();
        ...
        private void Create_Diet_Click_1(object sender, EventArgs e)
        {
            revert_Color();
            Main_Member.Hide();
            Create_Diet.BackColor = Color.MediumOrchid;//Salmon
            if (creatediet == null)
            {
                creatediet = new CreateDiet();
        ...
        private void Access_Diet_Click_1(object sender, EventArgs e)
        {
            revert_Color();
            Main_Member.Hide();
            Access_Diet.BackColor = Color.MediumOrchid;
            if (accessdiet == null)
            {
                accessdiet = new ViewDiet();
        ...
        private void Booking_Click_1(object sender, EventArgs e)
        {
            
        }

        private void HNDL_btn_Click_1(object sender, EventArgs e)
        {
            if (expand)
            {
                Sidebar.Width = 45;
        ...
        private void Booking1_Click(object sender, EventArgs e)
        {
            revert_Color();
            Main_Member.Hide();
            Booking1.BackColor = Color.MediumOrchid;
            if (booking == null)
            {
                booking = new Booking(username, userID);
        ...
        private void DASHBOARD1_Click(object sender, EventArgs e)
        {
            ...
            revert_Color();
            Main_Member.Hide();
            DASHBOARD1.BackColor = Color.MediumOrchid;
            if (dashboard == null)
            {
                dashboard = new Trainer_Dash();
